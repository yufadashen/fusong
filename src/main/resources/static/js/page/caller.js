...
//    dataTableUrl: "../js/page/ceshi.json"
}
var cPage = {
    winSize: {
...
//            url: cPageConfig.dataTableUrl,
            ...
            columns: [[
                ...
                { field: 'ptnId', title: '病人id',hidden:true },
                { field: 'requisitionId', title: '检查号',align:"center", width: 25 },
                { field: 'ptnName', title: '姓名', width: 10,align:"center", width: 20},
                { field: 'sex', title: '性别', align: "center", width: 10,formatter:formatSex },
                { field: 'emergencyId', title: '是否急诊', align: "center", width: 15,formatter:formatEmg},
...
//                }
    ...
    callMethod: function () {
    	$.ajax({
        	url:"http://127.0.0.1:801?Func=Sound_Play&Info=你好&zsName=13",
...
//    	var url = "callNextPatient.json?";
//    	if(rows.length==0){
//    		layer.msg("已无候诊病人",{icon: 1});
//    		return;
//    	}
//    	var nextId = "";
//    	if(rows.length>1){
...
//    	var id = rows[0]["id"];
//    	$.ajax({
//        	url:"callNextPatient.json?id="+id+"&nextId="+nextId,
//        	success:function(data){
//        		if (data.state) {
//					layer.msg(data.msg,{icon: 1});
//				}else{
...
//		str = "<font style='color:#ff0000'>"+val+"<font>";
		str = "女";
	}
	 return str;
}

function formatEmg(val,row,index){
	var str = "";
	if(val=='1'){
		str = "<font style='color:#ff0000'>"+"急诊"+"<font>";
	}
	return str;
}

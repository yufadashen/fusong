...
<script type="text/javascript">
    ...
    */
    ...
    //获取科室信息
    function getKeshi() {
        // var dateAfterNumber = getDateAfterNumber(1);
        // var nowHourMinuteSeconds = getNowHourMinuteSeconds(new Date());
        // window.parent.dateTimeTomorrow = dateAfterNumber + " " + nowHourMinuteSeconds;
        // var sevenDayAfter = getDateAfterNumber(7);
        // var sevenDayAfterWithSeconds = sevenDayAfter + " 23:59:59";
        // window.parent.dateTimeAfterSeven = sevenDayAfterWithSeconds;
        //
                    ...
                    for (var i = 0; i < length; i = i + 4) {
                        if (i + 3 < length) {
                            $("#info1").append(
                                ...
                                + "<td style=\"width:250px;height:80px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center\"><button class=\"layui-btn layui-btn-primary\" style=\"font-size:24px;width:250px;height:80px;\" value=\"" + Data.retbody[i].mzksbh + "\" onclick=\"clickKeshi(this)\">" + Data.retbody[i].mzksmc + "</button></td>"
                                + "<td style=\"width:250px;height:80px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center\"><button class=\"layui-btn layui-btn-primary\" style=\"font-size:24px;width:250px;height:80px;\" value=\"" + Data.retbody[i + 1].mzksbh + "\" onclick=\"clickKeshi(this)\">" + Data.retbody[i + 1].mzksmc + "</button></td>"
                                + "<td style=\"width:250px;height:80px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center\"><button class=\"layui-btn layui-btn-primary\" style=\"font-size:24px;width:250px;height:80px;\" value=\"" + Data.retbody[i + 2].mzksbh + "\" onclick=\"clickKeshi(this)\">" + Data.retbody[i + 2].mzksmc + "</button></td>"
                                + "<td style=\"width:250px;height:80px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center\"><button class=\"layui-btn layui-btn-primary\" style=\"font-size:24px;width:250px;height:80px;\" value=\"" + Data.retbody[i + 3].mzksbh + "\" onclick=\"clickKeshi(this)\">" + Data.retbody[i + 3].mzksmc + "</button></td>"
                                + "</tr>");
                        } else if (i + 2 < length) {
                            $("#info1").append(
                                "<tr style=\"width:1050px;height:80px\">"
...
$.session.set('keshi', keshi);
            ...
            window.location.href = "${pageContext.request.contextPath}/jsp/mzgh/yydoctor.jsp"
        }else{
            $.session.set('keshi', keshi);
            ksid00 = $(obj).val();
            $.session.set('ksid00', ksid00);
            window.location.href = "${pageContext.request.contextPath}/jsp/mzgh/yyDoctorIsExpert.jsp"
        }
    }
    // //今天的时间

...
<body scroll="no">
	...
	<div id="man_info" style="display:block">	
		...
		<div id="man"
			...
			<img id="manFront"
				src="${pageContext.request.contextPath}/images/zndz/womanFront.png"
				res_img="${pageContext.request.contextPath}/images/zndz/womanFront.png"
				height="" width="" />
		</div>
		<!-- 正反面按鈕 -->
		<div id="button"
		...
		<!-- 人體正面部位開始********** -->
		<div id="wuguan"
			style="position: absolute;top:337px;left:335px;z-index:999;">
		...
		<div id="huiyin"
			style="position: absolute;top:575px;left:265px;z-index:999;">
		...
		<div id="yanjing"
			style="position: absolute;top:300px;left:431px;z-index:999;">
		...
		<div id="jingbu"
			style="position: absolute;top:381px;left:255px;z-index:999;">
		...
		<div id="shangzhi"
			style="position: absolute;top:442px;left:280px;z-index:999;">
			<img
		...
		<div id="fubu"
			style="position: absolute;top:514px;left:319px;z-index:999;">
		...
		<div id="kouqiang"
			style="position: absolute;top:365px;left:783px;z-index:999;">
			<img
		...
		<div id="mianbu"
			style="position: absolute;top:310px;left:706px;z-index:999;">
		...
		<div id="xiongbu"
			style="position: absolute;top:442px;left:885px;z-index:999;">
		...
		<div id="pifu"
			style="position: absolute;top:527px;left:886px;z-index:999;">
		...
		<div id="xiazhi"
			style="position: absolute;top:725px;left:840px;z-index:999;">
...
<script type="text/javascript">
	...
	$("#frontButton").bind("click dbclick", function() {
		window.location.href = "womanTail.jsp";
	});
	/**
	* js分页类

...
<body scroll="no">
	...
	<div id="man_info" style="display:block">	
		...
		<div id="man"
			...
			<img id="manFront"
				src="${pageContext.request.contextPath}/images/zndz/manFront.png"
				res_img="${pageContext.request.contextPath}/images/zndz/manFront.png"
				height="" width="" />
		</div>
		<!-- 正反面按鈕 -->
		<div id="button"
			...
			<img id="frontButton"
				src="${pageContext.request.contextPath}/images/zndz/front.png"
				res_img="${pageContext.request.contextPath}/images/zndz/front.png"
				height="" width="" />
		</div>
		<!-- 人體正面部位開始********** -->
		<div id="wuguan"
			style="position: absolute;top:310px;left:440px;z-index:999;">
			<img src="${pageContext.request.contextPath}/images/zndz/wuguan.png"
				res_img="${pageContext.request.contextPath}/images/zndz/wuguan.png"
				value="10" onclick="getId(this)" />
		</div>
		<div id="huiyin"
			style="position: absolute;top:588px;left:257px;z-index:999;">
			<img src="${pageContext.request.contextPath}/images/zndz/huiyin.png"
				res_img="${pageContext.request.contextPath}/images/zndz/huiyin.png"
				value="7" onclick="getId(this)" />
		</div>
		<div id="yanjing"
			style="position: absolute;top:328px;left:268px;z-index:999;">
			<img src="${pageContext.request.contextPath}/images/zndz/yanjing.png"
				res_img="${pageContext.request.contextPath}/images/zndz/yanjing.png"
				value="11" onclick="getId(this)" />
		</div>
		<div id="jingbu"
			style="position: absolute;top:378px;left:269px;z-index:999;">
			<img src="${pageContext.request.contextPath}/images/zndz/jingbu.png"
				res_img="${pageContext.request.contextPath}/images/zndz/jingbu.png"
				value="9" onclick="getId(this)" />
		</div>
		<div id="shangzhi"
			style="position: absolute;top:472px;left:265px;z-index:999;">
			<img
				src="${pageContext.request.contextPath}/images/zndz/shangzhi.png"
				res_img="${pageContext.request.contextPath}/images/zndz/shangzhi.png"
				value="1" onclick="getId(this)" />
		</div>
		<div id="fubu"
			style="position: absolute;top:530px;left:258px;z-index:999;">
			<img src="${pageContext.request.contextPath}/images/zndz/fubu.png"
				res_img="${pageContext.request.contextPath}/images/zndz/fubu.png"
				value="16" onclick="getId(this)" />
		</div>
		<div id="kouqiang"
			style="position: absolute;top:365px;left:745px;z-index:999;">
			<img
				src="${pageContext.request.contextPath}/images/zndz/kouqiang.png"
				res_img="${pageContext.request.contextPath}/images/zndz/kouqiang.png"
				value="3" onclick="getId(this)" />
		</div>
		<div id="mianbu"
			style="position: absolute;top:317px;left:708px;z-index:999;">
			<img src="${pageContext.request.contextPath}/images/zndz/mianbu.png"
				res_img="${pageContext.request.contextPath}/images/zndz/mianbu.png"
				value="4" onclick="getId(this)" />
		</div>
		<div id="xiongbu"
			style="position: absolute;top:442px;left:787px;z-index:999;">
			<img src="${pageContext.request.contextPath}/images/zndz/xiongbu.png"
				res_img="${pageContext.request.contextPath}/images/zndz/xiongbu.png"
				value="15" onclick="getId(this)" />
		</div>
		<div id="pifu"
			style="position: absolute;top:545px;left:904px;z-index:999;">
			<img src="${pageContext.request.contextPath}/images/zndz/pifu.png"
				res_img="${pageContext.request.contextPath}/images/zndz/pifu.png"
				value="8" onclick="getId(this)" />
		</div>
		<div id="xiazhi"
			style="position: absolute;top:715px;left:845px;z-index:999;">
			<img src="${pageContext.request.contextPath}/images/zndz/xiazhi.png"
				res_img="${pageContext.request.contextPath}/images/zndz/xiazhi.png"
				value="2" onclick="getId(this)" />
		</div>
		<!--人体正面部位结束******************  -->
	</div>

	<!-- 返回主頁面 -->
	<div id="main" style="position: absolute;top:860px;left:320px;">
	...
	<!-- 返回上一步 -->
	<div id="pre" style="position: absolute;top:850px;left:760px;">
				...
				<tr>
					<td colspan="2"
						...
						<button id="pageup" style="font-size:35px;height:50px"
							...
							<button id="pagedown" style="font-size:35px;height:50px"
							class="layui-btn layui-btn-primary layui-btn-radius"
							onclick="page.nextPage();">下一页</button></td>				
				</tr>
			</tfoot>
		</table>
	</div>
...
<script type="text/javascript">
				...
				if (Data.retcode == "0") {
					for (var i = 0; i < Data.retbody.length; i++) {
						$("#info").append(
							...
							+ "<td style=\"width:160px;border:1px solid black;font-size:35px;text-align:center\">" + "<img  src='${pageContext.request.contextPath}/images/queding.png' "
	...
	//点击正面，顯示男性反面    
	$("#frontButton").bind("click dbclick", function() {
		window.location.href = "manTail.jsp";
	});
	/**
	* js分页类

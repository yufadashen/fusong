...
<body scroll="no">
	...
	<div id="man"
		...
		<img id="manFront"
			src="${pageContext.request.contextPath}/images/zndz/manTail.png"
			res_img="${pageContext.request.contextPath}/images/zndz/manTail.png"
			height="" width="" />
	</div>
	<!-- 正反面按鈕 -->
	<div id="button"
	...
	<!-- 人體反面部位開始********** -->
	<div id="lubu"
		style="position: absolute;top:311px;left:773px;z-index:999;">
	...
	<div id="yaobu"
		style="position: absolute;top:522px;left:270px;z-index:999;">
	...
	<div id="beibu"
		style="position: absolute;top:470px;left:795px;z-index:999;">
	...
	<div id="tunbu"
		style="position: absolute;top:580px;left:272px;z-index:999;">
	...
	<div id="quanshen"
		style="position: absolute;top:417px;left:275px;z-index:999;">
		<img src="${pageContext.request.contextPath}/images/zndz/quanshen.png"

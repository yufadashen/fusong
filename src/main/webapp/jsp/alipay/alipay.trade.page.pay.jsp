...
<%
	...
	String passback_params = new String(request.getParameter("WIDpassback_params").getBytes("UTF-8"),"UTF-8");
	...
	alipayRequest.setBizContent("{\"out_trade_no\":\""+ out_trade_no +"\"," 
			...
			+ "\"goods_type\":\"0\","
			+ "\"merchant_order_no\":\"商户原始账单号\","
			+ "\"product_code\":\"FAST_INSTANT_TRADE_PAY\"}");
	//request_from_url  请求来源地址。如果使用ALIAPP的集成方式，用户中途取消支付会返回该地址。

...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post accept-charset="utf-8"
              target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>自定义返回值 ：</dt>
					<dd>
						<input id="WIDpassback_params" name="WIDpassback_params" />
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
...
<script language="javascript">
	...
	function GetDateNow() {
        ...
        // datass = new String (source,"UTF-8");
		document.getElementById("WIDout_trade_no").value =  sNow;
		document.getElementById("WIDsubject").value = "挂号费支付";
		document.getElementById("WIDtotal_amount").value = "0.01";
		document.getElementById("WIDpassback_params").value = "返回字符串";
	}
	GetDateNow();
</script>
</html>
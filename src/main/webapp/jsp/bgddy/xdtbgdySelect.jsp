...
body {
	...
	text-align: center;
	margin:0px;
	background: url(../../images/m_mz_bgdy/3.png) no-repeat;
}
div{
	position: absolute;
...
<body scroll="no">
	...
	<div id="tmsm" style="position:absolute;top:308px;left:548px;width: 303px;height: 143px;">
		
	</div>
	<div id="srblh" style="position:absolute;top:549px;left:164px;width: 303px;height: 143px;">
		
	</div>
	<div id="duka" style="position:absolute;top:308px;left:164px;width: 303px;height: 143px;">
		
	</div>
	<div id="srzyh" style="position:absolute;top:549px;left:548px;width: 303px;height: 143px;">
...
<script type="text/javascript">
	function initialize	(){
		...
		$("#duka").bind("click dbclick", function() {//读卡查询页面
			window.parent.ttype = "32";
			window.location.href = "${pageContext.request.contextPath}/jsp/main/readcard.jsp";
		});
		$("#srzyh").bind("click dbclick", function() {//输入住院号查询页面
			window.location.href = "srzyh.jsp";
		});
	...
	**/
	var init = function(){
		$.session.set("printType01","xdtbgdy");
		initialize();
		returnTime();//倒计时

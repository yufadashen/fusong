...
<body scroll="no">
	...
	<div id="txm" style="width: 303px;height: 143px;margin:336px 0px 0px 158px;">
		<img alt="" src="../../images/yue/txm.png">
	</div>
	<div id="srblh" style="width: 303px;height: 143px;margin:336px 0px 0px 545px;">
...
<script type="text/javascript">
	...
	function initialize	(){
		$("#srblh").bind("click dbclick", function() {//检验报告打印

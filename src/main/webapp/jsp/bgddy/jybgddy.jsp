...
<body scroll="no">
	...
	<div id="jzk" style="width: 303px;height: 143px;margin:336px 0px 0px 41px;">
		<img alt="" src="../../images/yue/jzk.png">
	</div>
	<div id="txm" style="width: 303px;height: 143px;margin:336px 0px 0px 358px;">
		<img alt="" src="../../images/yue/txm.png">
	</div>
	<div id="srblh" style="width: 303px;height: 143px;margin:336px 0px 0px 679px;">

...
<body scroll="no" id="info">
	...
	<div id="titleArea">
		<font style="margin-left:40px;">输入病历号</font>
	</div>
	...
	<div id="showArea">
		...
		<div id="rebuildArea">
			<div style="margin-top: 80px;font-size: 35px;">
				<span style="color: red;">请&emsp;输&emsp;入&emsp;病&emsp;历&emsp;号：</span><br/><br/>
				<div
...
<script type="text/javascript">
	...
	***/
	  ...
	  $("#sure").bind("click", function() {
		  if(obj.val()!=""){
		  	$.session.set("printblh00",obj.val());
	...
	**/
	var init = function() {
		...
		$.session.set("printType02",printType01+"srblh");

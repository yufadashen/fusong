...
<body scroll=no>
		...
		<div style="position: absolute;left:12px;">
			<div id="ynjzk" style="position: absolute;top:400px;left:150px;">
			...
			<div id="dzjkk" style="position: absolute;top:400px;left:500px;">
			...
			<div id="stm" style="position: absolute;top:400px;left:850px;">
				 <img src="${pageContext.request.contextPath}/images/print/stm.png" res_img="${pageContext.request.contextPath}/images/print/stm.png" height="305" width="264"/>
			</div>
...
<script language="javascript">
	...
	$("#stm").bind("click dbclick", function() {
		window.location.href="${pageContext.request.contextPath}/jsp/printOf/readcardTM.jsp";
	});

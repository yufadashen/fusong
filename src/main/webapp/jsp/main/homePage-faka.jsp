...
<html>
 ...
 <body scroll="no">
	<div id='main_box'>
		<div id ="apDiv2">
			<iframe  id="pa" name="page1" src="${pageContext.request.contextPath}/jsp/main/main-faka.jsp" width="1280" height="1024" align="center" scrolling="no" frameborder="0" allowTransparency="false" ></iframe>
		</div>
	</div>
 </body>

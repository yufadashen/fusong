...
<script language="javascript">
	...
	/*  CardReader.SetDebug('DebugInfo');
  	var bStop =true;
  	var inputCount = 0;
  	var cardNO;//卡号
	var openr=CardReader.OpenDevice(1);
  	//读卡
  	var log = document.getElementById("AVFOCXLOG");
  	var temp = document.getElementById("AVFOCX");
	var ret = temp.OpenCardReaderX(1);  */
	$("#ewm").focus();
				...
				success:function(json){
					...
					Data = eval(json);
						if(Data.retcode == "0"){
							...
							if(Data.retbody[0].sfzhao=="" || Data.retbody[0].sfzhao==undefined){

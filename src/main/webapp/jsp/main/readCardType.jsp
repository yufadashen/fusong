...
<div id="word" style="width:100%;z-index:60;position:absolute;top:200px;left:0px;">
    <span style="width:100%;font-size:40px;text-align:center;color:#FF0000;">请选择读卡类型</span>
</div>
<div style="position: absolute;left:12px;">
    ...
    <div id="jbjzk" style="position: absolute;top:420px;left:160px;">
        <img src="${pageContext.request.contextPath}/images/cardOld.png"
             res_img="${pageContext.request.contextPath}/images/cardOld.png" height="310" width="305"/>
    </div>
    <%--旧版就诊卡--%>
    <div id="xbjzk" style="position: absolute;top:410px;left:500px;">
        <img src="${pageContext.request.contextPath}/images/cardNew.png"
             res_img="${pageContext.request.contextPath}/images/cardNew.png" height="340" width="330"/>
    </div>
    <%--医保卡--%>
    <div id="ybk" style="position: absolute;top:420px;left:880px;">
        <img src="${pageContext.request.contextPath}/images/yiBaoKaCustomer.png"
             res_img="${pageContext.request.contextPath}/images/yiBaoKaCustomer.png" height="310" width="305"/>
    </div>
</div>
<div id="main" style="position: absolute;top:803px;left:500px;">
    <img src="${pageContext.request.contextPath}/images/main.png" res_img="${pageContext.request.contextPath}/"
         height="" width=""/>
</div>
<div id="next" style="position: absolute;top:800px;left:660px;">
...
/*
    ...
    function testYb() {
      /*  var datas = {
            funcid: "M07.02.19.01",
            ybsflx: window.parent.cardNo,
            method: window.parent.cardtype,
            yllb00:
        };*/
    }
</script>

...
<script language="javascript" src="${pageContext.request.contextPath}/DriverJS/json2.js"></script>
...
<body scroll=no>
	...
	<div id="title"
			...
			<span id="error" style="font-size:40px;color:#EE7700;"><strong>请放入身份证</strong></span>
	</div>

...
<body scroll="no" onselectstart="return false">
	...
	<div id="titleArea">
		<font style="margin-left:40px;">选择预约时间</font>
	</div>
	<div id="showArea">
		<div style="font-size:44px;margin-top:25px;"><span style="margin-left:-170px;">请选择要预约的时间!</span></div>
...
<script type="text/javascript">
	...
	function clickKeshi(obj) {
		...
		//log.WriteLog("卡号为:"+cardNo+"选择科室为"+keshi);		
		var yysj00 = obj.children[1].innerText;
		$.session.set('yytime', keshi);
		$.session.set('yysj00', yysj00);
		window.location.href = "${pageContext.request.contextPath}/jsp/mzyy/yyconfirm.jsp";
		$("#waiting").show();
	}
					...
					if (Data.retcode == "0") {
						...
						for (var i = 0; i < length; i = i + 3) {
							if (i + 2 < length) {
								$("#info_t").append(
										"<tr>"
										+"<td><div class=\"models\" onclick=\"clickKeshi(this)\"> <span class=\"ksWz\">" + Data.retbody[i].yysjxs + "</span><span class=\"ksbh\">" + Data.retbody[i].yysj00 + "</span></div></td>"
										+"<td><div class=\"models\" onclick=\"clickKeshi(this)\"> <span class=\"ksWz\">" + Data.retbody[i+1].yysjxs + "</span><span class=\"ksbh\">" + Data.retbody[i+1].yysj00 + "</span></div></td>"
										+"<td><div class=\"models\" onclick=\"clickKeshi(this)\"> <span class=\"ksWz\">" + Data.retbody[i+2].yysjxs + "</span><span class=\"ksbh\">" + Data.retbody[i+2].yysj00 + "</span></div></td>"
										+"</tr>");
							} else if (i + 1 < length) {
								$("#info_t").append(
										"<tr>"

...
<body scroll="no" onselectstart="return false">
		...
		<div id="wxts"></div>
			<div id="rebuildArea">
				...
				<div style="margin-top: 20px;font-size: 20px;">身&nbsp;&nbsp;份&nbsp;&nbsp;&nbsp;证&nbsp;&nbsp;号：<font color="#85c531">_______________________</font>
					<div style="position: absolute;margin-left: 217px; margin-top: -38px;">
						<input id="idCard" onfocus="checkKeyPosition(this)" onblur="checkKeyPosition2(this)" type="text" style="height:30px;width:255px;border:1px black solid;background: none;">
					</div>
				</div>
				<div id="inputPhoneNo" style="margin-top: 20px;font-size: 20px;">输入电话号码：<font color="#85c531">_______________________</font>
					<div style="position: absolute;margin-left: 217px; margin-top: -38px;">
						<input id="phoneNo" onfocus="checkKeyPosition(this)" onblur="checkKeyPosition2(this)" maxlength="11" type="text" style="height:30px;width:255px;border:1px black solid;background: none;">
					</div>
				</div>
	...
	<div id="money"  style="z-index:1000; width:272px; position:absolute;top:475px;left:685px; border:1px black solid;background-color:#AFD3EC;">
    ...
    <img src="../../images/kb2/0.png" value="0"name="numKey" style="width:60px;height:53px;"/> 
	<img src="../../images/kb2/X.png" value="X"name="numKey" style="width:60px;height:53px;"/> 
    <img src="../../images/kb2/sure.png" value="11" id="sure" style="width:140px;height:53px;margin-top:4px;" />
  </div>
	<div id="bottomArea">
...
<script type="text/javascript">
		...
		$.ajax({
			...
			success : function(json) {
				//$.getJSON("../mzgh/yycx.json",function(json){//测试数据
					var Data = eval(json);
					if (Data.retcode == "0") {
						window.parent.lxdh00 = $("#phoneNo").val();
						window.parent.sfzhao = $("#idCard").val();
						var flag = $.session.get("backyemianname");//获取身份信息补录的跳转页面标识
						if(flag=="yykebie"){
							$.session.set("true","shenfenyanzheng");
	...
	**/
	...
	var obj = $("#idCard");
	function checkKeyPosition(obj1){
		obj = obj1;
		$(obj).css("background-color","#84C731");
	}
	function checkKeyPosition2(obj1){
		obj = obj1;
		$(obj).css("background-color","#CEF7F7");
	}
	/***
	***  键盘事件
	***/

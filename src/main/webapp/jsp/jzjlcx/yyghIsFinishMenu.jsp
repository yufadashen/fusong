...
<body scroll=no>
	...
	<div id="mzyywjz" style="position: absolute;top:450px;left:100px;width: 200px;height: 100px;background-color: #00FF00">
		<img src="${pageContext.request.contextPath}/images/mzyywjz.png" alt="">
	</div>
	<div id="mzyyyjz" style="position: absolute;top:450px;left:380px;width: 200px;height: 100px;background-color: #00FF00">
		<img src="${pageContext.request.contextPath}/images/mzyyyjz.png" alt="">
	</div>
	<div id="mzghwjz"style="position: absolute;top:450px;left:650px;width: 200px;height: 100px;background-color: #00FF00">
		<img src="${pageContext.request.contextPath}/images/mzghwjz.png" alt="">
	</div>
	<div id="mzghyjz"style="position: absolute;top:450px;left:930px;width: 200px;height: 100px;background-color: #00FF00">
		<img src="${pageContext.request.contextPath}/images/mzghyjz.png" alt="">
	</div>
...
<script language="javascript">
	...
	$("#tip_s").on("click", function() {
  	...
  	$("#mzyywjz").bind("click dbclick",function () {
  		//门诊预约未就诊
		$.session.set("yyzt00","0");//0为未就诊，1为已就诊
		$.session.set("yygh00","1")//1为预约，2为挂号
		window.location.href="${pageContext.request.contextPath}/jsp/jzjlcx/cxyygh.jsp";
	});
  	$("#mzyyyjz").bind("click dbclick",function () {
  		//门诊预约已就诊
		$.session.set("yyzt00","1");
		$.session.set("yygh00","1");
		window.location.href="${pageContext.request.contextPath}/jsp/jzjlcx/cxyygh.jsp";
	})
	$("#mzghyjz").bind("click dbclick",function () {
		//门诊挂号已就诊
		$.session.set("yygh00","2");
		$.session.set("yyzt00","1");
		window.location.href="${pageContext.request.contextPath}/jsp/jzjlcx/cxyygh.jsp";
	})
	$("#mzghwjz").bind("click dbclick",function () {
		//门诊挂号已就诊
		$.session.set("yygh00","2");
		$.session.set("yyzt00","0");
		window.location.href="${pageContext.request.contextPath}/jsp/jzjlcx/cxyygh.jsp";
	})
</script>
</html>

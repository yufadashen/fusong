...
body {
	...
	height: 100%;
	overflow: hidden;
	background:url(../../images/m_mz_mzbl/mzbl_query_pt.jpg) no-repeat;
}
#name00{
	top:120px;
	left:270px;
...
<script type="text/javascript">
	...
	function init(){
		$("#name00").text(window.parent.xming0);
		$("#idCard").text(window.parent.cardNo);
		$("#yjjyexs").text(window.parent.yjjye0);
		event();
	...
	function getReportInformation(){
		var datas = {
				...
				"brnl00" : window.parent.brnl00,        //病人年龄
		...
		$.ajax({
				...
				success : function(json) {
					...
					if(Data.retcode== "0"){
						...
						var jylsh0=Data.retbody[0].jylsh0;
						var pngurl = "http://188.188.28.81:7001"+Data.retbody[0].bmpurl;
						$.session.set('pngurl', pngurl);
						$.session.set('jylsh0', jylsh0);
						window.location.href = "${pageContext.request.contextPath}/jsp/blbdy/printpng.jsp";
					}else{
						$("#waiting").css("display","none");
						$("#tip_div").show();

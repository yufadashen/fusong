		...
		if (Data.retcode == "0") {
			...
			for (i = 0; i < length; i++) {
				if (j <= 8) {
					$("#info1").append(
						...
						+ "<th style=\"height:50px;border:1px solid black;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:25px;text-align:center\"><div style=\"width:60px;height:40px;background-color:#3f7dac;\">" + j + "</div></th>"
			...
			//正好查询出整页
				...
				for (var k = 1; k <= empt; k++) {	
					$("#info1").append(
						"<tr style=\"height:50px;border:1px solid black;\">"
						+ "<th style=\"height:50px;border:1px solid black;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:25px;text-align:center\"><div style=\"width:60px;height:40px;background-color:#3f7dac;\">" + xh + "</div></th>"

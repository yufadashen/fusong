...
<script type="text/javascript">
	...
	function initialize() {
		...
		$("#manageArea").bind("click", function() {
			//cNum++;
			if(cNum == 0){
				$.session.set("stoping","backMain");
				reader.CardSetting(1);//前端可以进卡
				window.location.href="${pageContext.request.contextPath}/jsp/manageop/checkPage.jsp";
			}
		});
	}
